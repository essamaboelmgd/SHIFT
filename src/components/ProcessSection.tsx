...
export default function ProcessSection() {
  ...
  return <section ref={sectionRef} className={`process-section${hasEntered ? ' is-visible' : ''}`} id="process" aria-labelledby="process-title"><div className="process-section__canvas">
    ...
    <p className="process-section__meta process-section__meta--section" dir="ltr">03 / PROCESS</p><p className="process-section__meta process-section__meta--context" dir="ltr"><span className="process-section__meta--context-desktop">THE SHIFT&nbsp; / &nbsp;NEXT</span><span className="process-section__meta--context-mobile">THE SHIFT</span></p>
